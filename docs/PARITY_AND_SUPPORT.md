...
| Image import | Implemented in pre-alpha interface and core, workflow limited | Local multi-file import and native review selection exist; broad duplicate policy, copy/move file management, and production workflow support remain incomplete |
