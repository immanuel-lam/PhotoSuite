...
| Metadata | IPTC, EXIF, XMP, keywords, face data | Partially implemented in pre-alpha core, workflow not yet integrated | Durable IPTC/EXIF/XMP-like fields, keyword normalisation/search, v1-to-v2 catalog migration, preset save/list/apply/delete, reopen, and source-immutability tests exist; metadata inspector and batch UI, embedded/sidecar XMP writing, full field coverage, hierarchical keyword taxonomies, and face data remain incomplete |
