...
| Image import | Implemented in pre-alpha interface and core, workflow limited | Local multi-file import, native review selection, and one-asset fingerprint-validated missing-source relink exist; broad duplicate policy, copy/move file management, batch relink, and production workflow support remain incomplete |
...
| Catalog migration and recovery | Implemented in pre-alpha interface and core, workflow limited | SQLite migrations, integrity checks, bookmarks, backups, jobs, reopen tests, and a native one-asset missing-source relink flow with fingerprint and security-scope checks exist; batch relink and full user recovery tooling remain incomplete |
