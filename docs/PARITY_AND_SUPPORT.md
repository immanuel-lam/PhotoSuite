...
| Develop | Non-destructive adjustment workflow | Implemented in pre-alpha interface and core, workflow limited | Native basic adjustment, crop canvas gestures, rotation, undo, redo, and before/after controls exist; durable recipes, Develop preset save/list/apply/delete, and tested baseline tone, white-balance, transform, detail, bounded lens distortion, chromatic-aberration approximation, defringe, vignette correction, creative vignette, grain, dehaze, calibration, black-and-white, HDR-intent, three-way grade, and histogram core exist ([crop tests](../PhotoSuiteApp/Tests/CropInspectorTests.swift), [crop gesture tests](../PhotoSuiteApp/Tests/CropCanvasGestureTests.swift), [Develop render tests](../Tests/RenderCoreTests/DevelopRenderTests.swift), [optics UI tests](../PhotoSuiteApp/Tests/ModernUIContractTests.swift)); Adobe-equivalent camera profiles, Lensfun data integration, full HDR output, and complete workflow validation remain incomplete |
