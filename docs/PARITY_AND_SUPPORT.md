...
| Library | Catalog, folders, collections, search, metadata | Implemented in pre-alpha interface and core, workflow limited | SQLite catalog/search/jobs/bookmarks/backups and native browsing, rating, colour-label, search, smart-filter, durable regular/smart collections, photo-stack controls, hierarchical keyword nodes and asset assignments, folder hierarchy and asset assignment, native keyword/folder controls, independent virtual-copy recipe history, native virtual-copy controls, durable face-region/label records, and local Vision face-rectangle detection exist ([catalog tests](../Tests/CatalogCoreTests/KeywordAndVirtualCopyTests.swift), [folder tests](../Tests/CatalogCoreTests/FolderCatalogTests.swift), [face tests](../Tests/CatalogCoreTests/FaceCatalogTests.swift), [Vision face tests](../Tests/RenderCoreTests/VisionFaceDetectionTests.swift), [workspace tests](../Tests/PhotoWorkflowTests/PhotoWorkspaceTests.swift)); people UI, identity recognition, keyword-node authoring, Lightroom migration, and broader metadata workflows remain incomplete |
...
| Metadata | IPTC, EXIF, XMP, keywords, face data | Partially implemented in pre-alpha interface and core, workflow limited | Durable IPTC/EXIF/XMP-like fields, atomic XMP sidecar write/read, bounded standards-based Adobe XMP Develop-preset import with skipped-field reporting, keyword normalisation/search, hierarchical keyword nodes and asset assignments, schema-v1-to-v7 catalog migration, preset save/list/apply/delete, durable face regions/labels/search/delete, local Vision face-rectangle detection, reopen, source-immutability tests, and a Library metadata editor exist ([keyword tests](../Tests/CatalogCoreTests/KeywordAndVirtualCopyTests.swift), [face tests](../Tests/CatalogCoreTests/FaceCatalogTests.swift), [Vision face tests](../Tests/RenderCoreTests/VisionFaceDetectionTests.swift), [XMP tests](../Tests/PhotoWorkflowTests/XMPSidecarWriterTests.swift), [preset-import tests](../Tests/PhotoWorkflowTests/XMPDevelopPresetImporterTests.swift)); batch metadata UI, embedded XMP writing, full field coverage, complete taxonomy authoring, identity recognition, and people UI remain incomplete |
...
| Location, face, and other sensitive metadata | Partially implemented in pre-alpha interface and core, workflow limited | Deliver has selected JPEG metadata policies; GPS extraction, durable face regions/labels, and unlabeled local Vision face geometry exist, while EXIF, IPTC, XMP, identity recognition, people UI, location round-trip, and default-disclosure rules remain incomplete |
