...
| Develop | Non-destructive adjustment workflow | Implemented in pre-alpha interface and core, workflow limited | Native basic adjustment, crop, rotation, undo, redo, and before/after controls exist; durable recipes, Develop preset save/list/apply/delete, and tested baseline tone, white-balance, transform, detail, optics, effects, calibration, black-and-white, HDR-intent, three-way grade, and histogram core exist ([crop tests](../PhotoSuiteApp/Tests/CropInspectorTests.swift)); Adobe-equivalent profiles, lens database integration, dehaze, grain, full HDR output, and complete workflow validation remain incomplete |
